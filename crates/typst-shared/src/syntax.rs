...
impl SyntaxMark {
    pub fn encode(self) -> i32 {
        match self {
            ...
            SyntaxMark::NodeStart(SyntaxKind::Bang) => 75,
            SyntaxMark::NodeStart(SyntaxKind::Not) => 76,
            SyntaxMark::NodeStart(SyntaxKind::And) => 77,
            SyntaxMark::NodeStart(SyntaxKind::Or) => 78,
            SyntaxMark::NodeStart(SyntaxKind::None) => 79,
            SyntaxMark::NodeStart(SyntaxKind::Auto) => 80,
            SyntaxMark::NodeStart(SyntaxKind::Let) => 81,
            SyntaxMark::NodeStart(SyntaxKind::Set) => 82,
            SyntaxMark::NodeStart(SyntaxKind::Show) => 83,
            SyntaxMark::NodeStart(SyntaxKind::Context) => 84,
            SyntaxMark::NodeStart(SyntaxKind::If) => 85,
            SyntaxMark::NodeStart(SyntaxKind::Else) => 86,
            SyntaxMark::NodeStart(SyntaxKind::For) => 87,
            SyntaxMark::NodeStart(SyntaxKind::In) => 88,
            SyntaxMark::NodeStart(SyntaxKind::While) => 89,
            SyntaxMark::NodeStart(SyntaxKind::Break) => 90,
            SyntaxMark::NodeStart(SyntaxKind::Continue) => 91,
            SyntaxMark::NodeStart(SyntaxKind::Return) => 92,
            SyntaxMark::NodeStart(SyntaxKind::Import) => 93,
            SyntaxMark::NodeStart(SyntaxKind::Include) => 94,
            SyntaxMark::NodeStart(SyntaxKind::As) => 95,
            SyntaxMark::NodeStart(SyntaxKind::Code) => 96,
            SyntaxMark::NodeStart(SyntaxKind::Ident) => 97,
            SyntaxMark::NodeStart(SyntaxKind::Bool) => 98,
            SyntaxMark::NodeStart(SyntaxKind::Int) => 99,
            SyntaxMark::NodeStart(SyntaxKind::Float) => 100,
            SyntaxMark::NodeStart(SyntaxKind::Numeric) => 101,
            SyntaxMark::NodeStart(SyntaxKind::Str) => 102,
            SyntaxMark::NodeStart(SyntaxKind::CodeBlock) => 103,
            SyntaxMark::NodeStart(SyntaxKind::ContentBlock) => 104,
            SyntaxMark::NodeStart(SyntaxKind::Parenthesized) => 105,
            SyntaxMark::NodeStart(SyntaxKind::Array) => 106,
            SyntaxMark::NodeStart(SyntaxKind::Dict) => 107,
            SyntaxMark::NodeStart(SyntaxKind::Named) => 108,
            SyntaxMark::NodeStart(SyntaxKind::Keyed) => 109,
            SyntaxMark::NodeStart(SyntaxKind::Unary) => 110,
            SyntaxMark::NodeStart(SyntaxKind::Binary) => 111,
            SyntaxMark::NodeStart(SyntaxKind::FieldAccess) => 112,
            SyntaxMark::NodeStart(SyntaxKind::FuncCall) => 113,
            SyntaxMark::NodeStart(SyntaxKind::Args) => 114,
            SyntaxMark::NodeStart(SyntaxKind::Spread) => 115,
            SyntaxMark::NodeStart(SyntaxKind::Closure) => 116,
            SyntaxMark::NodeStart(SyntaxKind::Params) => 117,
            SyntaxMark::NodeStart(SyntaxKind::LetBinding) => 118,
            SyntaxMark::NodeStart(SyntaxKind::SetRule) => 119,
            SyntaxMark::NodeStart(SyntaxKind::ShowRule) => 120,
            SyntaxMark::NodeStart(SyntaxKind::Contextual) => 121,
            SyntaxMark::NodeStart(SyntaxKind::Conditional) => 122,
            SyntaxMark::NodeStart(SyntaxKind::WhileLoop) => 123,
            SyntaxMark::NodeStart(SyntaxKind::ForLoop) => 124,
            SyntaxMark::NodeStart(SyntaxKind::ModuleImport) => 125,
            SyntaxMark::NodeStart(SyntaxKind::ImportItems) => 126,
            SyntaxMark::NodeStart(SyntaxKind::ImportItemPath) => 127,
            SyntaxMark::NodeStart(SyntaxKind::RenamedImportItem) => 128,
            SyntaxMark::NodeStart(SyntaxKind::ModuleInclude) => 129,
            SyntaxMark::NodeStart(SyntaxKind::LoopBreak) => 130,
            SyntaxMark::NodeStart(SyntaxKind::LoopContinue) => 131,
            SyntaxMark::NodeStart(SyntaxKind::FuncReturn) => 132,
            SyntaxMark::NodeStart(SyntaxKind::Destructuring) => 133,
            SyntaxMark::NodeStart(SyntaxKind::DestructAssignment) => 134,
            SyntaxMark::NodeEnd => 135,
            SyntaxMark::Error(idx) => 136 + idx,
        }
    }
}
